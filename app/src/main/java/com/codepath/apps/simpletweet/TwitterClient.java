...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "ONxjhgjzMt66USorZeNozfLJO";       // Change this
	public static final String REST_CONSUMER_SECRET = "l1pmRjzyjJNEHNeAYorR3SOdKn8BExpJgjDDrUZm9wqPi7nLSO"; // Change this
    ...
    public void getOwner(AsyncHttpResponseHandler handler) {
